...
/* function that returns an int */
   my_namespace private function performSelect(z:com.temp.MyType, r:boolean, arg3: boolean, arg4: boolean
   , arg5:boolean):int
   {
...
var objectDef:Object={name:"Item1", value:52000000, color:"red", width:100, height:800, source:variableRef, alignment:this.Left};
 var blah:ArrayCollection = new ArrayCollection([{topping:"Pepperoni", calories: 400},
 {topping:"Sausage", calories: 550},{topping:"Ham", calories: 240},{topping:"Chicken", calories: 110},{topping:"Ground Beef", calories: 375},{topping:"Bacon", calories: 330},{topping:"Canadian Bacon", calories: 100}]);
 
 var myArray=[["1","2","3"],["4","5","6"]];
 trace(myArray[0][1]);  
  
  performSelect(new MyType(),getBooleanValueFromSomewhereElse(true,true),true, getBooleanValueFromSomewhereElse(true
  , false), false, true);
//TODO: Single line comment in column 1
		var b:boolean=getValue(1,2)&&(setValue(3,4,5,false) ? setValue(3,4,5,true):doAnotherOperation("some data", 3,4,5))
	|| cancelOperation(20); 
  do
  {
...
public function get isSimple():Boolean  {return true;}
}
}