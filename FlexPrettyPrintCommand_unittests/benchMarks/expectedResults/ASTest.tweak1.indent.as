/**package comment*/package com.sas
{
  import com.sas.C2;
  import com.sas.*;
  ...
  public class MyClass extends com.sas.C3 implements com.sas.C1, C2 
  {
    ...
    private var v:Vector.<MyData>=new Vector.<MyData>([{"label":1, "used":5, "free":10}],
    ...
    public const z2:String="A string value", z3:String="sdlfkj", i:int=2*3;
    var x:*=2;

    var x:com.internal.static.default.to.each.namespace.dynamic.final.override.native.get.set;
    ...
    [Bindable]
    public function MyClass(x:int, y:com.sas.MyClass=null, ... others:Array) : com.sas.MyClass
    {
      use namespace t,q;
      var v:Vector=new Vector([{"label":1, "used":5, "free":10}], [{"label":2, "used":5, "free":36}]);
      var x:int;		var x;
      var x:int=2;	var x:com.company.ClassName=new com.company.ClassName(3);
      ...
      Config::debug {trace("debugging output");}
      ...
      var x:XML=<a>
          <tagB/>
          <tagc/>
          <tag attr1="attr" attr2="sdlfkjsdf">
            some data1
            some data2
      ...
      var x:XML=<>
          <abc/>
          <tag attr1="sldkfjsdlfkj" attr2="sldkjfsdlkfj">
            <subTag/>
          </tag>
        </>
      ...
      b=(a + (b+funcCall(3,4,4,5,3,"sldkjfsdlkfj") )/(c + d)) >> ((((2*74+funcCall(3)))))
    ...
    public override function thisFunctionHasAVeryLongNameThatRequiresWrappingSometimes(x:com.sas.Type1, z:com.sas.Type2, ... z:int):com.sas.ClassType
    {
      firstMethodCall(arg1, secondMethodCall(arg2, arg3), thirdMethodCall(arg4, fourthMethodCall("sdfsf", "sldkfsjldfkj", true),arg5));
      a[4]=2;
