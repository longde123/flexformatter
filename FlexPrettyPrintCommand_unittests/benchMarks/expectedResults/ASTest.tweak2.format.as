...
package com.sas {
    ...
    public class MyClass extends com.sas.C3 implements com.sas.C1 ,C2 {
        ...
        private var v:Vector.<MyData> = new Vector.<MyData>([{"label": 1 ,"used": 5 ,
                "free": 10}] ,[{"label": 2 ,"used": 5 ,"free": 36}]);
        [Bindable]
        [Transient]
        ...
        public function MyClass(x:int ,y:com.sas.MyClass = null ,... others:Array):com.
            sas.MyClass {
            use namespace t ,q;
            var v:Vector = new Vector([{"label": 1 ,"used": 5 ,"free": 10}] ,[{"label": 2 ,
                    "used": 5 ,"free": 36}]);
            var x:int;
            var x;
            var x:int = 2;
            ...
            while (true)
                ;
            b = (a+(b+funcCall(3 ,4 ,4 ,5 ,3 ,"sldkjfsdlkfj"))/(c+d))>>((((2*74+
                funcCall(3)))))
            b = /abc/;
        ...
        public override function thisFunctionHasAVeryLongNameThatRequiresWrappingSometimes(x:com.
            sas.Type1 ,z:com.sas.Type2 ,... z:int):com.sas.ClassType {
            firstMethodCall(arg1 ,secondMethodCall(arg2 ,arg3) ,thirdMethodCall(arg4 ,
                fourthMethodCall("sdfsf" ,"sldkfsjldfkj" ,true) ,arg5));
            a[4] = 2;
