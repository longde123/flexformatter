...
package com.sas {
    ...
    public class MyClass extends com.sas.C3 implements com.sas.C1 ,C2 {
        ...
        private var v:Vector.<MyData> = new Vector.<MyData>([{"label":1 ,"used":5 ,"free":10}] ,[{"label":2 ,"used":5 ,"free":36}]);
        [Bindable]
        [Transient]
        ...
        [Bindable] public function MyClass(x:int ,y:com.sas.MyClass=null ,... others:Array):com.sas.MyClass {
            use namespace t ,q;
